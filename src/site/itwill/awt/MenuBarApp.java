...
public MenuBarApp(String title) {
	...
	//MenuBar 클래스: 메뉴를 부착하기 위한 메뉴 컴퍼넌트 >> 프레임 부착
	MenuBar mb=new MenuBar();
	
	//Menu 클래스 : 메뉴 아이템을 부착하기 위한 컴퍼넌트 >> 메뉴바 부착
	Menu file=new Menu("파일");
	Menu help=new Menu("도움말");
	
	//MenuItem 클래스 : 선택 기능을 제공하기 위한 컴퍼넌트 >> 메뉴 부착
	//MenuShortcut 클래스: 단축키 기능을 제공하기 위한 클래스 >> Ctrl+key(int)
	//KeyEvent 클래스 : 키보드 관련 정보를 젖아할 목적의 클래스 - 상수필드로 키보드 정보가 표현
	MenuItem open = new MenuItem("열기", new MenuShortcut(KeyEvent.VK_0));
