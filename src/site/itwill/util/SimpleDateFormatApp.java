...
public class SimpleDateFormatApp {
	public static void main(String[] args) throws ParseException {
		// ■ SimpleDateFormat(String pattern) : 파라메터에 날짜와 시간에 대한 패턴정보를 전달받아
		// SimpleDateFormat 인스턴스를 생성하는 생성자
		// => 날짜와 시간 관련 정보를 패턴기호로 표현 :y,M,d,H,m,s,E 등
		...
		// SimpleDateFormat 인스턴스에 저장된 패턴정보를 변경하는 메소드
		...
		//타임스템프값을 사용하는 이유 : 날짜와 시간정보에 대한 연산(+,-) 목적(주로 -목적)
