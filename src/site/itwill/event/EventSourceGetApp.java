...
public class EventSourceGetApp extends Frame implements ActionListener { // implements ActionListener 상속으로
	...
	public EventSourceGetApp(String title) {
		...
		// 여기서 발생되는 이벤트는 다 엑션이벤트가 처리할 것이고 그것은 자기자신
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (eventSource instanceof MenuItem) {
			...
			((Button) eventSource).setEnabled(false);// 형변환
			if (eventSource == red) {
