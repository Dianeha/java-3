...
public class MultiButtonEventHandlerApp2 extends Frame {
	...
	public MultiButtonEventHandlerApp2(String title) {
		super(title);
	...
	*/
	...
	public class ColorButtonHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			//ActionCommand(Button, Menu) : ActionEvent를 발생한 컴퍼넌트의 동작 관련 문자열 - 버튼의 기본 ActionCommand는 버튼 라벨명으로 설정
