...
public class ConsoleIOApp {
	public static void main(String[] args) throws IOException {
		...
		//System.out.print() 또는 System.out.println() 메소드를 이용하여 모니터 출력
		// => 어떤 형태의 값을 전달받아도 문자열로 변경하여 출력하는 메소
		System.out.print("이름입력 >> ");
		// BufferedReader.readLine() : 입력스트림의 변형데이터를 문자열로
		...
		System.out.println("[결과]"+name+"님의 나이는 "+age+"세입니다.");
	}
}
